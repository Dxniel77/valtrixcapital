...
import { adminCopyTraderTargetSchema } from "@/lib/copy-trading/admin-schema";
import { isDatabaseAvailable } from "@/lib/db/available";
import {
  CopyTradingError,
  updateAdminCopyTraderTarget,
...
export async function PATCH(req: Request, { params }: Params) {
  ...
  const parsed = adminCopyTraderTargetSchema.safeParse(
  ...
  try {
    ...
    const trader = await updateAdminCopyTraderTarget(id, parsed.data, admin.id);
